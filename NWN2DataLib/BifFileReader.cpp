...
--*/
{
	...
	*BytesRead = 0;
	...
	BytesToRead = min( BytesToRead, ResElem->FileSize - Offset);
...
--*/
{
	...
	return (ResType) Key->ResourceType;
}
...
--*/
{
	...
	Type = (ResType) ResKey->ResourceType;
...
template BifFileReader< NWN::ResRef16 >;
