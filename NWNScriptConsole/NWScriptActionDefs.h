...
Module Name:
	...
	NWScriptActionDefs.h

Abstract:

	This module houses the ordinal definitions for each NWScript action.  The
	ordinals for each action must match those in nwscript.nss.

	A user can include this module after defining the "DECLARE_NSS_HANDLER"
	macro in order to perform an operation for each script action (create a
	stub, register a handler, etc).

--*/

//
// N.B.  Intentionally no include guard.
//

//
// N.B.  Below this point is automatically generated!  Do not edit.
//
